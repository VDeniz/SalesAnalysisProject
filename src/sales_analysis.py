...
os.makedirs("C:/sales_env/src", exist_ok=True)
os.makedirs("C:/sales_env/data/input", exist_ok=True)
os.makedirs("C:/sales_env/data/output", exist_ok=True)  # Added to ensure output directory exists
...
try:
    df = spark.read.option("header", "true").csv("C:/sales_env/data/input/superstore_data_extended.csv")
...
WHERE family IN ({})
GROUP BY family
""".format(",".join("'{}'".format(node.replace("'", "''")) for node in subgraph.nodes()))
...
with open("C:/sales_env/data/output/key_categories_graph.html", "w", encoding="utf-8") as f:
    f.write(html_content)
print("Interactive graph and query results saved to C:/sales_env/data/output/key_categories_graph.html")
...
with open("C:/sales_env/data/output/xgboost_model_step3.pkl", "wb") as f:
    pickle.dump(xgb_model, f)
print("XGBoost model saved to C:/sales_env/data/output/xgboost_model_step3.pkl")
...
with open("C:/sales_env/data/output/Chart.html", "w", encoding="utf-8") as f:
    f.write(charts_content)
print("Combined charts saved to C:/sales_env/data/output/Chart.html")
...
key_categories_path = os.path.abspath("C:/sales_env/data/output/key_categories_graph.html")
charts_path = os.path.abspath("C:/sales_env/data/output/Chart.html")
...
pdf.cell(0, 10, 'Graph-Based Sales Impact (Eigenvalues Centrality):', 0, 1)
...
pdf.output("C:/sales_env/data/output/Sales_Analysis_Report.pdf")
print("PDF report saved to C:/sales_env/data/output/Sales_Analysis_Report.pdf")
pdf_path = r"C:\sales_env\data\output\Sales_Analysis_Report.pdf"
